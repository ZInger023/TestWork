...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="px-3">
    <h1> <br><br><br>Добро пожаловать!</h1><br><br><br>
    <p class="lead">Вы находитесь на главной странице,для перехода к использованию функционала проекта нажмите на соответствующую надпись в правом верхнем углу.</p>
  </main>
