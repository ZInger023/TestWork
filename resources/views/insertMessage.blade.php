                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="600" class="w320">
                    <tr>
                            ...
                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" width="100%" bgcolor="#4dbfbf">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <center>
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" width="60%">
                                                <tr>
                                                    <td style="color:#187272;">
                                                        <br>
                                                        <h2><h2>Новая заявка от пользователя {{ $user->name }}</h2>
                                                            <br>
                                                            <br>
                                                    </td>
                                                </tr>
                        ...
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                          ...
                          <center>
                        <![endif]-->
                                            <a href="{{url('/')}}/message/{{$messageId}}"
                                               style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Перейти к заявке!</a>
                                            <!--[if mso]>
                                              </center>
                                            </v:roundrect>
                                          <![endif]--></div>
