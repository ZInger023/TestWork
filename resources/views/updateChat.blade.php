...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main class="px-3">
        ...
        <form method="post" action="/updateChatMessage/{{$chatMessage->id}}" >
            @csrf
            <input type="text" name="text" id="text" class="form-control" value="@php echo $chatMessage->text @endphp" required="" autofocus="">
